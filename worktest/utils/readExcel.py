...
if __name__ == '__main__':  # 我们执行该文件测试一下是否可以正确获取Excel中的值
    #print(ReadExcel().get_xls('TestCase_MerchantCancel.xlsx', 'Sheet1'))
    print(ReadExcel().get_xls('TestCase_MerchantCancel.xlsx', 'Sheet1')[0][0])
    print(ReadExcel().get_xls('TestCase_MerchantCancel.xlsx', 'Sheet1')[0][4])